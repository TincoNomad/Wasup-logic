...
var ConnectionController = {
  ...
  setClient(client) {
    state12._client = ref(client);
  },
  connectWalletConnect() {
    state12.wcPromise = this._getClient().connectWalletConnect((uri) => {
      state12.wcUri = uri;
...
var SnackController = {
  ...
  showSuccess(message) {
    ...
    state13.variant = "success";
    state13.open = true;
  },
  showError(message) {
    state13.message = message;
    state13.variant = "error";
    state13.open = true;
  },
  hide() {
    state13.open = false;
...
//# sourceMappingURL=chunk-LENHRBXJ.js.map
