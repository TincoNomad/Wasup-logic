...
import {
  ...
  setThemeVariables,
  state
} from "./chunk-JI3VTJIH.js";
import {
  require_buffer
} from "./chunk-LKYF3ZV2.js";
import "./chunk-HV2FVXRY.js";
import "./chunk-UGAR5Y5J.js";
...
import {
  ...
  watchAccount,
  watchNetwork
} from "./chunk-GZOTHMHG.js";
import "./chunk-WII55DLE.js";
import "./chunk-ZNECZODT.js";
import {
  createWalletClient,
  custom,
  mainnet
} from "./chunk-JXE7JSB2.js";
import "./chunk-ZGMMTKQL.js";
import "./chunk-Q7KHIBTE.js";
import "./chunk-DXPWN2PM.js";
import {
  SwitchChainError,
  UserRejectedRequestError,
  getAddress,
  numberToHex
} from "./chunk-KQSU3BLN.js";
...
W3mConnectingWcView = __decorate11([
...
W3mNetworkSwitchView = __decorate14([
...
W3mWhatIsANetworkView = __decorate16([
...
W3mWhatIsAWalletView = __decorate17([
...
W3mAllWalletsList.styles = styles_default6;
__decorate18([
  state()
...
W3mAllWalletsList = __decorate18([
...
W3mAllWalletsSearch.styles = styles_default7;
__decorate19([
  state()
...
W3mAllWalletsSearch = __decorate19([
...
W3mConnectingHeader = __decorate20([
...
W3mConnectingWcBrowser = __decorate21([
...
W3mConnectingWcDesktop = __decorate22([
...
W3mConnectingWcMobile = __decorate23([
...
W3mConnectingWcQrcode.styles = styles_default8;
W3mConnectingWcQrcode = __decorate24([
...
W3mConnectingWcUnsupported = __decorate25([
...
W3mConnectingWcWeb = __decorate26([
...
W3mHeader.styles = [styles_default9];
__decorate27([
  state()
...
W3mLegalFooter.styles = [styles_default10];
W3mLegalFooter = __decorate29([
...
W3mSnackBar.styles = styles_default12;
__decorate31([
  state()
], W3mSnackBar.prototype, "open", void 0);
W3mSnackBar = __decorate31([
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([import("./esm-EQYNIUPG.js"), import("./w3m-modal-AJLYFUDQ.js")]);
...
var WALLET_CONNECT_CONNECTOR_ID = "walletConnect";
var INJECTED_CONNECTOR_ID = "injected";
var COINBASE_CONNECTOR_ID = "coinbaseWallet";
var SAFE_CONNECTOR_ID = "safe";
var LEDGER_CONNECTOR_ID = "ledger";
var EIP6963_CONNECTOR_ID = "eip6963";
var NAMESPACE = "eip155";
var ADD_CHAIN_METHOD = "wallet_addEthereumChain";
var WALLET_CHOICE_KEY = "wagmi.wallet";
var EIP6963_ANNOUNCE_EVENT = "eip6963:announceProvider";
var EIP6963_REQUEST_EVENT = "eip6963:requestProvider";
var VERSION = "3.1.0";

// node_modules/@web3modal/wagmi/dist/esm/src/utils/presets.js
var NetworkImageIds = {
...
function caipNetworkIdToNumber(caipnetworkId) {
...
var Web3Modal = class extends Web3ModalScaffold {
  constructor(options) {
    ...
    const networkControllerClient = {
      switchCaipNetwork: async (caipNetwork) => {
        const chainId = caipNetworkIdToNumber(caipNetwork == null ? void 0 : caipNetwork.id);
        if (chainId) {
      ...
      async getApprovedCaipNetworksData() {
        ...
        if (walletChoice == null ? void 0 : walletChoice.includes(WALLET_CONNECT_CONNECTOR_ID)) {
          ...
          const nsMethods = (_c = ns == null ? void 0 : ns[NAMESPACE]) == null ? void 0 : _c.methods;
          const nsChains = (_d = ns == null ? void 0 : ns[NAMESPACE]) == null ? void 0 : _d.chains;
          return {
            supportsAllNetworks: nsMethods == null ? void 0 : nsMethods.includes(ADD_CHAIN_METHOD),
    ...
    const connectionControllerClient = {
      connectWalletConnect: async (onUri) => {
        ...
        const chainId = caipNetworkIdToNumber((_a2 = this.getCaipNetwork()) == null ? void 0 : _a2.id);
      ...
      connectExternal: async ({ id, provider, info }) => {
        ...
        const chainId = caipNetworkIdToNumber((_b = this.getCaipNetwork()) == null ? void 0 : _b.id);
        await connect({ connector, chainId });
      },
      checkInstalled: (ids) => {
  ...
  getState() {
    ...
    return {
      ...state2,
      selectedNetworkId: caipNetworkIdToNumber(state2.selectedNetworkId)
    };
  }
  subscribeState(callback) {
  ...
  listenConnectors(wagmiConfig) {
    const connector = wagmiConfig.connectors.find((c) => c.id === EIP6963_CONNECTOR_ID);
      ...
      window.addEventListener(EIP6963_ANNOUNCE_EVENT, (event) => {
        ...
        if (event.detail) {
          ...
          this.addConnector({
            ...
            type: "ANNOUNCED",
            imageUrl: info.icon ?? ((_b = (_a2 = this.options) == null ? void 0 : _a2.connectorImages) == null ? void 0 : _b[EIP6963_CONNECTOR_ID]),
            name: info.name,
            provider,
            info
          });
...
var CoinbaseWalletConnector = class extends Connector {
  ...
  async getProvider() {
    var _a2;
    if (!__privateGet(this, _provider)) {
      let CoinbaseWalletSDK = (await import("./dist-MIUK2C7A.js")).default;
...
initProvider_fn = async function() {
  const { EthereumProvider, OPTIONAL_EVENTS, OPTIONAL_METHODS } = await import("./index.es-NEMKDIAE.js");
...
getNamespaceChainsIds_fn = function() {
  ...
  const chainIds = (_c = (_b = normalizedNamespaces[NAMESPACE2]) == null ? void 0 : _b.chains) == null ? void 0 : _c.map(
...
getNamespaceMethods_fn = function() {
  ...
  if (!namespaces)
    return [];
  const normalizedNamespaces = se(namespaces);
  const methods = (_b = normalizedNamespaces[NAMESPACE2]) == null ? void 0 : _b.methods;
  return methods ?? [];
};
